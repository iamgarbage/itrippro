...
public class PaymentController {
    ...
    public String prePay(@PathVariable String orderNo, ModelMap model) {
        try {
            ...
            if (null != order) {
                ...
                model.addAttribute("hotleName", order.getHotelName());
    ...
    public void pay(String WIDout_trade_no,
        ...
        //调用RSA签名方式
        AlipayClient client = new DefaultAlipayClient(AlipayConfig.getURL(), AlipayConfig.getAPPID(), AlipayConfig.getRsaPrivateKey(), AlipayConfig.getFORMAT(), AlipayConfig.
                getCHARSET(), AlipayConfig.getAlipayPublicKey(), AlipayConfig.getSIGNTYPE());
    ...
    public void notify(HttpServletRequest request,HttpServletResponse response){
        try {
            ...
            boolean verify_result = AlipaySignature.rsaCheckV1(params, AlipayConfig.getAlipayPublicKey(),
            ...
            if(verify_result){//验证成功
                ...
                if(trade_status.equals("TRADE_FINISHED")){
                    ...
                    //如果有做过处理，不执行商户的业务程序
                    orderService.paySucce(out_trade_no,1,trade_no);
                    //注意：
