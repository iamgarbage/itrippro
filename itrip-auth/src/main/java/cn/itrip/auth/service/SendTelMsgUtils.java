...
public class SendTelMsgUtils {
	 ...
	 */
	public static final String ACCOUNT_SID = "f90b3746509f42569f622835d7b87c6a";

	/**
	 * AUTH_TOKEN:开发者账号认证密匙(注册后自动生成)
	 */
	public static final String AUTH_TOKEN = "6f6478131f764535bf7fca4af23aa723";
	 ...
	 */
	private static String smsContent = "【爱上天】您的验证码为"+randNum+"，请于"+TIME+"，分钟内正确输入，如非本人操作，请忽略此短信。";
	...
	public static void main(String[] args) {
		System.out.println(sendMsgTo("19973535706"));
		System.out.println(randNum);
	}
	public String Verification(String Number){
		 sendMsgTo(Number);
		 System.out.println(sendMsgTo("19973535706"));
		 System.out.println(randNum);
		 return randNum;
