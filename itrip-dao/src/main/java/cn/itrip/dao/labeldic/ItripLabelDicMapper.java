...
public interface ItripLabelDicMapper {
	...
	public ItripLabelDicVO getItripLabelDicById(@Param(value = "id") Long id)throws Exception;

	public List<ItripLabelDicVO>	getItripLabelDicListByMap(Map<String, Object> param)throws Exception;

	public Integer getItripLabelDicCountByMap(Map<String, Object> param)throws Exception;

	public Integer insertItripLabelDic(ItripLabelDicVO itripLabelDic)throws Exception;

	public Integer updateItripLabelDic(ItripLabelDicVO itripLabelDic)throws Exception;
